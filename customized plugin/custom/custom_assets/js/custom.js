...
jQuery(document).ready(function($) {
    ...
    $('#product-category').on('input', function(){
        ...
        $('#products-dropdown-menu li').click(function(){
            ...
            $.ajax({
              url: 'https://xxxxx.com/wp-admin/admin-ajax.php',
              type: 'post',
              data: {
...
jQuery(document).ready(function() {
    ...
    jQuery("#delete-ads-modal #yesBtn").click(function(e) {
        ...
        jQuery.ajax({
            type: 'post',
            url: "https://xxxxx.com/wp-admin/admin-ajax.php", // Path to your PHP file
            data: {
    ...
    jQuery("#send-comment-search").click(function(){
        ...
        jQuery.ajax({
            ...
            success: function(response) {
                ...
                location.reload();
                // window.location.href = "https://xxxxx.com/deal-page";
            },
            error: function(xhr, status, error) {
                console.error(xhr.responseText); // Log error to console
            }
...
jQuery(document).ready(function($){
    ...
    $('.show_if_seller').children().eq(7).after('<p class="term-link"><a href="https://xxxxx.com/wp-content/uploads/2024/01/terms.pdf" target="_blank" rel="noopener noreferrer">Please read Terms & Condition. Click here.</a></p>');
...
jQuery(document).ready(function($){
    var pathname = window.location.href;
    if(pathname.includes('/store/')){
        $("head").append("<link rel='stylesheet' id='elementor-frontend-css' href='https://xxxxx.com/wp-content/plugins/elementor/assets/css/frontend.min.css?ver=3.21.4' type='text/css' media='all'>");
        $("head").append("<link rel='stylesheet' id='elementor-frontend-css' href='https://xxxxx.com/wp-content/plugins/elementor-pro/assets/css/frontend.min.css?ver=3.21.4' type='text/css' media='all'>");
    
        // Remove the CSS file from the HTML page
        $("link[href='https://xxxxx.com/wp-content/plugins/elementor/assets/css/frontend-lite.min.css?ver=3.21.4']").remove();
        $("link[href='https://xxxxx.com/wp-content/plugins/elementor-pro/assets/css/frontend-lite.min.css?ver=3.21.2']").remove();
        ...
        var alert = $("p.dokan-info:contains('No products were found on this vendor!')").each(function(){
                $(this).text('This vendor has not yet made their products or services available through xxxxx. If you would like to shop at their store online, please ask them to contact us to upload their products so you can buy from them conveniently.')
            })
    }
});