                        ...
                        <div class="bs-component">
                            <div class="card mb-3">
                                ...
                                <ul class="list-group list-group-flush">
                                    ...
                                    <li class="list-group-item c-d-flex">Send comment to xxxxx Inc &nbsp;&nbsp;&nbsp; <span class="email_send_btn"><i class="fa-solid fa-paper-plane"></i></span></li>
                                </ul>
                            </div>
                        </div>
            </div>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        document.getElementById('searchButton').addEventListener('click', function() {
                ...
                if(paramInput.value !==""){
                    var newUrl = 'https://xxxxx.com/deal-page?' + "search=" + paramInput.value + "&searchBy=" + paramBy.value;
                    window.location.href= newUrl;
                }
            });
        document.getElementById('showAll').addEventListener('click', function() {
                var newUrl = 'https://xxxxx.com/deal-page';
                window.location.href= newUrl;
            });
    });
</script>
