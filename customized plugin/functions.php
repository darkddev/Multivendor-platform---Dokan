...
// Send request to add User on Subdomain(restaurant, ...)
    ...
    // );
    // $response = wp_remote_post('https://restaurants.xxxxx.com/wp-json/restaurant/user/create/', array(
    //     'method' => 'POST',
    //     'headers'     => array(
...
// Send request to add Vendor info on Subdomain(restaurant, ...)
    ...
    //     );
    //     $response = wp_remote_post('https://restaurants.xxxxx.com/wp-json/restaurant/vendor/create/', array(
    //         'method' => 'POST',
    //         'headers'     => array(
    //             'Content-Type' => 'application/json',
    //         ),
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.getElementById('searchButton').addEventListener('click', function() {
                ...
                if(paramInput.value !==""){
                    var newUrl = 'https://xxxxx.com/wp-admin/admin.php?page=dokan-vendor-import' + "&search=" + paramInput.value + "&searchBy=" + paramBy.value;
            ...
            document.getElementById('showAll').addEventListener('click', function() {
                ...
                var newUrl = 'https://xxxxx.com/wp-admin/admin.php?page=dokan-vendor-import';
                window.location.href= newUrl;
            });
        });
    </script>
